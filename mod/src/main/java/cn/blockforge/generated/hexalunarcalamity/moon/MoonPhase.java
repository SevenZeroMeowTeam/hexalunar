...
public enum MoonPhase {
    ...
    MoonPhase(String id, String zhName, int fogColor, int skyTint, int dustColor, boolean superMoon,
              float spawnMultiplier, float speedBonus, float dropMultiplier, float eliteChance,
              float alarmPitch, Supplier<SoundEvent> alarmSound) {
        this.id = id;
        this.zhName = zhName;
