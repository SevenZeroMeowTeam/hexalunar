    ...
    public static final RegistryObject<CreativeModeTab> MAIN = TABS.register("main",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((params, output) -> {
                        ...
                        output.accept(new ItemStack(ModItems.KAR98K.get()));
                        output.accept(new ItemStack(ModItems.MOSIN_NAGANT.get()));
                        output.accept(new ItemStack(ModItems.M1_GARAND.get()));
                        ...
                        output.accept(new ItemStack(ModItems.AMMO_762_59.get()));
                        output.accept(new ItemStack(ModItems.AMMO_762_61.get()));
                        ...
                        output.accept(new ItemStack(ModItems.AMMO_BOX_762_59.get()));
                        output.accept(new ItemStack(ModItems.AMMO_BOX_762_61.get()));
