...
CASES = {
    'akm': ('akm.geo.json', 'akm.json', [0, 0, 0], [-2.6, 1.4, 1.8], [1, 1, 1],
            [('照门叶片顶', (0.0, 3.44, -4.75)), ('准星柱顶', (0.0, 3.44, -10.72)),
             ('导轨齿顶', (0.0, 3.44, -5.90)), ('枪管轴', (0.0, 1.75, -10.72))]),
    ...
    'bow_draw': ('compound_bow.geo.json', 'compound_bow.json', [0, 0, 0],
                 ...
                 [('瞄准圈圆心', (0.0, 2.86, -4.12)), ('箭杆', (0.0, 0.85, -8.0))]),
    # ★ r111 M1 加兰德：觇孔圆心 = 准星片顶 = 3.44（v2 模型）；举枪增量 = WeaponMount.M1_AIM_*
    'm1': ('m1_garand.geo.json', 'm1_garand.json', [0, 0, 0], [-5.0, -1.15, 0.5], [1, 1, 1],
           [('觇孔圆心', (0.0, 3.44, -0.42)), ('准星片顶', (0.0, 3.44, -13.24)),
            ('枪管轴', (0.0, 2.30, -13.60))]),
    'm1_aim': ('m1_garand.geo.json', 'm1_garand.json', [0, 0, 0],
               [-5.0 - 3.96, -1.15 + 6.03, 0.5 + 1.9], [1, 1, 1],
               [('觇孔圆心', (0.0, 3.44, -0.42)), ('准星片顶', (0.0, 3.44, -13.24)),
                ('枪管轴', (0.0, 2.30, -13.60))]),
}
